...
const page: React.FC<pageProps> = () => {
  ...
  return (
    <div className=" h-[99vh] lg:h-[100vh] md:h-[100vh] w-full bg-[#2b2b31] flex justify-center items-start sm:items-center lg:items-center">
      <div
        className="bg-te w-full h-[90%]  md:w-[50%] md:h-[80%] lg:w-[30%] lg:h-[96vh] flex flex-col items-center gap-2   justify-around
     "
      >
