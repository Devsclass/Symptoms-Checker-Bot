    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-blue-600 font-medium">Last updated: {currentDate}</p>
        </div>
        ...
        <div className="max-w-4xl mx-auto bg-white p-6 md:p-8 rounded-xl shadow-lg border border-gray-100">
          ...
          <section className="mb-12">
            <div className="flex flex-col md:flex-row items-start mb-6">
              <div className="bg-blue-100 p-3 rounded-lg mb-4 md:mb-0 md:mr-4">
          ...
          <div className="space-y-8 md:space-y-12">
            {/* Data Collection */}
            <section className="p-4 md:p-6 bg-blue-50 rounded-lg border-l-4 border-blue-500">
            ...
            {/* Data Usage */}
            <section className="p-4 md:p-6 bg-green-50 rounded-lg border-l-4 border-green-500">
              <div className="flex items-center mb-4">
            ...
            {/* Data Protection */}
            <section className="p-4 md:p-6 bg-purple-50 rounded-lg border-l-4 border-purple-500">
              <div className="flex items-center mb-4">
              ...
              <div className="space-y-3 md:space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm md:text-base">All data is encrypted in transit and at rest using industry-standard protocols.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-white p-2 rounded-lg mr-3 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm md:text-base">Strict access controls limit who can view your personal information.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-white p-2 rounded-lg mr-3 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm md:text-base">Health data used for research is anonymized to protect your identity.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              {/* Third Parties */}
              <section className="p-4 md:p-6 bg-yellow-50 rounded-lg border-l-4 border-yellow-400">
              ...
              {/* Children's Privacy */}
              <section className="p-4 md:p-6 bg-pink-50 rounded-lg border-l-4 border-pink-400">
                <div className="flex items-center mb-3">
              ...
              {/* Policy Changes */}
              <section className="p-4 md:p-6 bg-indigo-50 rounded-lg border-l-4 border-indigo-400">
                <div className="flex items-center mb-3">
              ...
              {/* Contact */}
              <section className="p-4 md:p-6 bg-teal-50 rounded-lg border-l-4 border-teal-400">
                <div className="flex items-center mb-3">
                ...
                <Link href="/contact" className="text-teal-600 font-medium hover:underline inline-flex items-center text-sm md:text-base">
          ...
          {/* Final Note */}
          <div className="mt-8 md:mt-12 p-4 md:p-6 bg-gray-50 rounded-lg text-center">
            <p className="text-gray-600 text-sm md:text-base">
